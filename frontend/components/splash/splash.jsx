            ...
            <div>
                ...
                <div className="info-container-2">
                    <div className="content-container-row">
                        ...
                        <div className="content-image-1a">
                ...
                <div className="info-container-2">
                    <div className="content-container-row">
                        <div className="content-image-1b">
                        </div>
                        <div className="content-blurb-1">
                            <h1>From a few to a fandom</h1>
                            <p>Get a community of any size running with moderation 
                ...
                <div className="info-container-3">
                    <div className="content-container-col-2">
                        <div className="content-blurb-2">
                            ...
                            <p>Low-latency voice and video feels like you’re in 
                                the same room. Wave hello over video, watch
                                 friends stream their games, or gather up and 
                                 have a drawing session with screen share.</p>
                        </div>
